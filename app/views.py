...
bp = Blueprint('blueprint', __name__, template_folder='templates', url_prefix='/api')
...
def login():
    ...
    if (user_entry):
        ...
        if (user.password == jsdjango-admin-script.py startproject mysiteon_payload['password']):  # not for prod
            login_user(user)
